...
public class MobileStudentController {
    ...
    public ResponseEntity<ResponseObject<Boolean>> registerDeviceToken(
            HttpServletRequest request, @RequestBody DeviceTokenRequest deviceTokenRequest) {

        String token = jwtHelper.cleanToken(request.getHeader(HttpHeaders.AUTHORIZATION));
        Integer studentId = jwtHelper.extractStudentId(token);
        Integer tenantId = jwtHelper.extractTenantId(token);

        mobileStudentService.registerDeviceToken(studentId, tenantId, deviceTokenRequest);
    ...
    public ResponseEntity<ResponseObject<Boolean>> unregisterDeviceToken(
            HttpServletRequest request, @RequestBody DeviceTokenRequest deviceTokenRequest) {
        ...
        mobileStudentService.unregisterDeviceToken(studentId, tenantId, deviceTokenRequest.getFcmToken());
